          ...
          <div class="col-lg-4">
            ...
            <h3>Full Stack Web Developer</h3>
              <p>
                  ...
                  and deployment automation. Passionate about developing clean, maintainable code, and creating optimal user experiences.
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>03 Dec 1993</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>https://www.omkaravinashd.me</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+1 475 280 0399</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Bridgewater, MA</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>omkaravinashd.work@gmail.com</span></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">JavaScript and Node.js <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Docker/DevOps <i class="val">70%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                ...
                <li>(475) 280-0399</li>
                <li>omkaravinashd.work@gmail.com</li>
              </ul>
            </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>omkaravinashd.work@gmail.com</p>
              </div>
